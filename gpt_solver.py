...
def ask_gpt(prompt: str) -> Tuple[str, str]:
    try:
        response = client.chat.completions.create(
            model=PRIMARY,
            messages=[
                {"role": "system", "content": "Ты — математический ассистент. Отвечай просто и кратко. Не используй LaTeX, Markdown, **жирный текст**, кавычки и форматирование. Делай 2-4 шага с пояснениями, если надо. Каждый шаг в формате:\nШаг N: выражение\nИ в конце напиши:\nОтвет: число или фраза."},
